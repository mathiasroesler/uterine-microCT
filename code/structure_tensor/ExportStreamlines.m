function ExportStreamlines(Paths,EField,Fname,GroupName,NodeOffset,ElementOffset)
  ...
  for p=1:length(Paths)
      ...
      if ~isempty(Paths{p})
          ...
          for d = 1:1 % just go one way with streamlines for now.
              ...
              fprintf(fidn,' Node: %d\n',NodeNumber);
              fprintf(fidn,'  %e %e %e %e\n',Paths{p}{d}(1,1),Paths{p}{d}(1,2),Paths{p}{d}(1,3),FA1);
              ...
              for n=2:size(Paths{p}{d},1)
                  ...
                  fprintf(fidn,' Node: %d\n',NodeNumber);
                  fprintf(fidn,'  %e %e %e %e\n',Paths{p}{d}(n,1),Paths{p}{d}(n,2),Paths{p}{d}(n,3),FA1);
                  NodeNumber = NodeNumber+1;
