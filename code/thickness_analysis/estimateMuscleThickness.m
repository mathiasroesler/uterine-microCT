function [muscle_thickness_array, slice_thickness_array] = estimateMuscleThickness( ...
    img_stack, centreline, nb_points, slice_nbs)
%ESTIMATEMUSCLETHICKNESS Estimates the muscle thickness of each slice.
% 	
% 	Input:
% 	 - img_stack, stack of images to process (ZXY dimensions).
% 	 - centreline, coordinates of the centre point on each slice.
% 	 - nb_points, number of points to use for projection.
% 	 - slice_nbs, number of the slices at which to save angular thickness.
% 
% 	Return:
% 	 - muscle_thickness_array, muscle thickness of each slice.
% 	 - slice_thickness_array, muscle thickness at different angles
% 		for three slices.
