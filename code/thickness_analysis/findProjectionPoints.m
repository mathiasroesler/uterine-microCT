...
%FINDPROJECTIONPOINTS Find the projection points from the centre point onto
% the muscle layers in four directions (top, bottom, left, right)
% 
% 	Input:
% 	 - img, image to analyse.
% 	 - centre_point, coordinates of the centre point.
% 	 - nb_points, number of desired projection points, must be a multiple of 2.
% 
% 	Return:
% 	 - projection_points, list of the coordinates of the projection points.
